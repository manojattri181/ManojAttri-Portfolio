...
const Home = () => {
  return (
    <div
      name="home"
      className="w-full  mx-auto pt-10 md:pt-28 bg-gradient-to-b from-black via-black to-gray-800  "
    >
      <div className="max-w-screen-lg mx-auto grid lg:grid-cols-2 items-center">
    <div className='px-8 py-12 max-w-lg mx-auto sm:max-w-xl lg:px-12 lg:py-24 lg:max-w-full'>
          ...
          <div className="max-w-screen-sm flex justify-center items-center space-x-8">
            <div >
    ...
    <img className="mx-auto rounded-2xl w-7/12 object-cover object-center md:w-7/12  lg:w-7/12" src={HeroImage} alt="logo" />
      </div>
    </div>
  );
};
